...
margin-bottom: 28px;
`;
const CommentHeading2 = styled.p`
font-size: 18px;
margin-bottom: 21px;
font-weight:600;
`;
...
export default function () {
  ...
  return (
    ...
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "row",marginLeft:12,justifyContent:'space-between',width: 1100,marginLeft: 100 }}>
      ...
      <div onClick={handleClick(SlideTransition)} style={{ backgroundColor: '#FFF1EC',width:50,height:50,padding:'12px 16px',borderRadius:50,marginRight:12 }}>
          ...
          <div style={{ backgroundColor: '#FFF1EC',width:50,height:50,padding:'12px 16px',borderRadius:50,marginRight:12 }} >
            <img onClick={handleClickOpen} src="../icons/comment-icon.svg" alt="comment-icon" />
          </div>
      ...
      <img
        ...
        style={{ width: 1100, height: 500,marginLeft:10,borderRadius:10,marginBottom:80,marginLeft:100 }}
        alt="card-image"
      />
...
<CommentHeading2>Write a comment</CommentHeading2>

<CommentInput></CommentInput>
<div style={{display: "flex"}}>
<div style={{width: "30px",height:"30px",color:"tomato",borderRadius:"50%",backgroundColor:"tomato",border:"none"}}>hlo</div>

<CommentAccount>
Account Name</CommentAccount>
</div>
...
<div style={{borderLeft:"2px solid #000000",width:"100%"}}>
<div style={{display:"flex",justifyContent:"center"}}>
<p style={{fontSize:"25px",fontWeight:600}}>Recommended for you</p>
...
<Snackbar
      ...
      />
      <Dialog open={buttonPopup} onClose={handleClickClose}>
        <DialogTitle style={{}}>
        Copy Link 
        <Button style={{fontWeight: 700, color: "#000000",}} onClick={handleClickClose} color="primary">
           X
          </Button>
<div>
  <input type="text" placeholder="copy data"/>
</div>
        </DialogTitle>
        <DialogContent>
          <DialogContentText stype={{color:"#1F1F1F",fontSize:"15px",fontWeight:600}}>
          Share Directly On
          </DialogContentText>
        </DialogContent>
        <DialogActions>
