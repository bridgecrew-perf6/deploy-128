  ...
  return (
    ...
    <div className='col pl-0' style={{display:"flex",justifyContent:"space-between"}}>
      ...
      <div className="form-row">
        ...
        <div style={{fontSize:"18px",fontWeight:"500"}}>Test name*</div>
        ...
        <div style={{fontSize:"18px",fontWeight:"500"}} >Duration in minutes*</div>
        ...
        <div class="form-group col-lg-12">
        <div style={{fontSize:"18px",fontWeight:"500"}}>Difficulty level*</div>
 <select onChange={(event)=>setType(event.target.value)} class="form-control b-field-height" id="inputEmail4">
              <option></option>
              <option value="First">First</option>
              <option value="Second">First</option>
...
{/* 
      <div class="form-group">
        <label for="inputAddress2" className='b-font'>Marks for correct answer*</label>
      ...
      <div class="form-group">
        <label for="inputAddress2" className='b-font'>How soon will you update the student results?*</label>
  <select onChange={(event)=>setType(event.target.value)} class="form-control b-field-height" id="inputEmail4">
              <option></option>
              <option value="First">First</option>
              <option value="Second">First</option>
...
<button /*onClick={addExperience}*/ onClick={handleTest}
style={{backgroundColor:"#000000", color:"#ffffff",border:"none",borderRadius:"5px",width:"250px",height:"50px",margin:"30px 0 20px 0"}} >Next</button>
    </>
    </div>
  )
}
