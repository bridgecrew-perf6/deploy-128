...
const FavStudItems = styled.div`
  ...
  margin-bottom:80px;
`;
const FavStudContainer = styled.div`
  display: flex;
...
const DivIconrow = styled.div`
  ...
  justify-content:space-between;   
`;
const FavStudTopHead = styled.span`
  font-family: "Inter";
  font-style: normal;
  font-weight: 600;
  font-size: 25px;
...
const ProductOverlay = styled.div`
  ...
  position:absolute;
`;
const StudFavProductCard = styled.div`
  width: 300px;
  height: 413px;
...
export default function ProductCarousel() {
  return (
    ...
    <Carousel style={{marginBottom:"10px"}} BreakPoints={BreakPoints} pagination={false}>
        ...
        <FavStudItems> 
          <StudFavProductCard>{/* product card div */}
          <ProductOverlay>
          <Checkbox
          sx={{
          color: grey[100],
...
< img src="https://images.unsplash.com/photo-1644982648774-83312909bbef?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" />
    <DivIconrow>
              <IconsContainer> <img src="../close.svg" /> </IconsContainer>
              <IconsContainer> <img src="../shoppingcart.svg" /> </IconsContainer>
              <IconsContainer> <img src="../star.svg" /> </IconsContainer>
</DivIconrow>
</ProductContent>
        ...
        </StudFavProductCard></FavStudItems>
        <FavStudItems> <StudFavProductCard>{/* product card div */}
          <ProductOverlay>
          <Checkbox
      sx={{
       color: grey[100],
...
< img src="https://images.unsplash.com/photo-1644982648774-83312909bbef?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" />
    <DivIconrow>
        ...
        </StudFavProductCard></FavStudItems><FavStudItems> <StudFavProductCard>{/* product card div */}
          <ProductOverlay>
          <Checkbox
      sx={{
       color: grey[100],
