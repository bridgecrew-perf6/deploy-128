...
const StudListAccordian = () => {
  const [accordexpanded, setAccordExpanded] = useState('panel1');
      ...
      <div className="container-fluid b-container">
       ...
       <button style={{backgroundColor:"#F24F17",color:"#ffffff",border:"none",outline:"none",width:"150px",height:"50px"}}>Save</button>
        ...
        {/* <div className="row b-pad">
          <AccordionBox accordexpanded={accordexpanded === 'panel1'} onChange={handleChange('panel1')} >
            <AccordionSummaryBox
        ...
        <Typography sx={{ color: 'text.secondary' }} className="b-typo-dis">
          ...
          <AccordionBox accordexpanded={accordexpanded === 'panel3'} onChange={handleChange('panel3')} >
            <AccordionSummaryBox
            style={ changeBackground === "panel2" ? {backgroundColor:"#F4F4F4",borderBottomLeftRadius:"0px" ,borderBottomRightRadius:"0px"} : {backgroundColor:"white"}}
              expandIcon={<ExpandMoreIcon   />}
              aria-controls="panel2bh-content"
        ...
        <div className="row b-pad">
          <AccordionBox accordexpanded={accordexpanded === 'panel2'} onChange={handleChange('panel2')} >
            <AccordionSummaryBox
            style={ changeBackground === "panel2" ? {backgroundColor:"#F4F4F4",borderBottomLeftRadius:"0px" ,borderBottomRightRadius:"0px"} : {backgroundColor:"white"}}
              expandIcon={<ExpandMoreIcon   />}
              aria-controls="panel2bh-content"
        ...
        {/* <div className="row b-pad">
          <AccordionBox accordexpanded={accordexpanded === 'panel4'} onChange={handleChange('panel4')} >
            <AccordionSummaryBox
            style={ changeBackground === "panel2" ? {backgroundColor:"#F4F4F4",borderBottomLeftRadius:"0px" ,borderBottomRightRadius:"0px"} : {backgroundColor:"white"}}
              expandIcon={<ExpandMoreIcon   />}
              aria-controls="panel2bh-content"
        ...
        <div className="row b-pad">
          <AccordionBox accordexpanded={accordexpanded === 'panel5'} onChange={handleChange('panel5')} >
            <AccordionSummaryBox
            style={ changeBackground === "panel2" ? {backgroundColor:"#F4F4F4",borderBottomLeftRadius:"0px" ,borderBottomRightRadius:"0px"} : {backgroundColor:"white"}}
              expandIcon={<ExpandMoreIcon   />}
              aria-controls="panel2bh-content"
        ...
        <div className="row b-pad">
          <AccordionBox accordexpanded={accordexpanded === 'panel6'} onChange={handleChange('panel6')} >
            <AccordionSummaryBox
            style={ changeBackground === "panel2" ? {backgroundColor:"#F4F4F4",borderBottomLeftRadius:"0px" ,borderBottomRightRadius:"0px"} : {backgroundColor:"white"}}
              expandIcon={<ExpandMoreIcon   />}
              aria-controls="panel2bh-content"
        ...
        <div className="row b-pad">
          <AccordionBox accordexpanded={accordexpanded === 'panel7'} onChange={handleChange('panel7')} >
            <AccordionSummaryBox
            style={ changeBackground === "panel2" ? {backgroundColor:"#F4F4F4",borderBottomLeftRadius:"0px" ,borderBottomRightRadius:"0px"} : {backgroundColor:"white"}}
              expandIcon={<ExpandMoreIcon   />}
              aria-controls="panel2bh-content"
...
export default StudListAccordian;