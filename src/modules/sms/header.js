        ...
        <Toolbar>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: "none", md: "flex" } }}>
            ...
            <Buttons
              ...
              sx={{ my: 2, color: "white", display: "block" }}
            >
              <Link to={"/professional-personaldetail"}> Jobs </Link>
            </Buttons>
            <Buttons
              onClick={handleCloseNavMenu}
              sx={{ my: 2, color: "white", display: "block" }}
            ...
            <div className="pms_sidebar_contents_box">
              <div className="pms_sidebar_contents">
                <span>
                  ...
                  <Link className="contents" to="/student-profile">
                    Personal Deatils
                  </Link>
                </span>
              </div>
              ...
              <div className="pms_sidebar_contents">
                <span>
                  ...
                  <Link className="contents" to="/studentresume">
                    Resume
                  </Link>
                </span>
              </div>
              <div className="pms_sidebar_contents">
                <span>
                  ...
                  <Link className="contents" to={"/student-project"}>
                    {" "}
                    Projects{" "}
                  </Link>{" "}
                </span>
              ...
              <div className="pms_sidebar_contents">
                <span>
                  <img src="icons/favourites.svg" alt="mail" />{" "}
                  <Link className="contents" to={"/studentfavorite"}>
                    Favourites{" "}
                  </Link>{" "}
                </span>
              </div>
