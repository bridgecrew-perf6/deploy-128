      ...
      <div className="container-fluid dis-container">
        <div className="container-main-pms">
          ...
          <div className="row pad_pms">
            <div className="col-8">
              <div className="row dis-title">Branch Details</div>
              <div className="row"><div className="DistributionHeadline"></div></div>
            </div>
            <div className="col-4 pr-0">
              <Link to="branchTable"><button type="button" className="SubmitTopButtonDis float-right">SUBMIT</button></Link>
            </div>
                ...
                <Typography>
                  ...
                  <div>
                    ...
                    <div className="form-row">
                          <label for="inputPassword4" className='font-dis'>Branch Contact Person Name*</label>
                        </div>
                      <div className="form-row">
                        <div class="form-group col-lg-6">
                          <input type="email" class="form-control field-height-dis" id="inputEmail4" placeholder="First Name" />
                        </div>
