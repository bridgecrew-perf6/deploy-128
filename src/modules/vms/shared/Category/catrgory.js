      ...
      <div className="container-fluid dis-container">
        ...
        <div className="row pad">
          <div className="col-8">
            ...
            <div className="row dis-dis">
              Please input requested details below. Click submit once you are
              done
            </div>
          </div>
          <div className="col-4 pr-0">
            <button type="button" className="submit-top-button float-right">
              Submit
            </button>
          </div>
        </div>
        ...
        {/* headline */}
        <div className="row category-field-height">
                ...
                <div className="row category-list-area">
                  ...
                  <div className="col sub-category">
                    <div className="nolist-material-sub-category">
                      {showList ? (
                        <div className="row sub-category-list">
                          {BuildingMaterial.map((item) => (
                            <span className="list-text">
                              <input
                                className="sub-category-checkbox"
                                type="radio"
                                onClick={() => setSub(!showSub)}
                                placeholder="hello"
                              />{" "}
                              {item}
                            </span>
                  ...
                  <div className="col sub-sub-category">
                    {showList ? (
                      <div className="row sub-sub-category-list">
                        {showSub ? (
                          <>
                            {Bricks.map((item) => (
                              <span className="list-text">
          ...
          <div className="col show-subcategory-area">show selected list</div>
        </div>
      </div>
    </>
  );
