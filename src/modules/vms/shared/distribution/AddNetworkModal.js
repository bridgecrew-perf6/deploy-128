              ...
              <div className="row">
                ...
                <div className="col-6">
                  <div className="dis-title-modal ml-orange float-right">
                    <p className='nested1' onClick={handleOpen2} ><span className='hidden_dis_modal' >Have </span>Many Networks?</p>
                  </div>
                </div>
              </div>
              ...
              <form className='row'>
                <div className='col-12 scroll_modal'>
                  <div className="row pad-top-modal-content">
                    <div class="col-md-12">
                      <label className='modal-label'>Firm Name</label>
          ...
          <div className='pad-modal-content'>
            ...
            <div className='form-row'>
              <div className="col input-group pt-1">
                ...
                <div className="input-group-prepend">
                  <button className="delete-modal-button"><img className='logo' src='/icons/delete-icon.svg' height="10px" width="10px" /></button>
                </div>
                <div className="input-group-prepend">
